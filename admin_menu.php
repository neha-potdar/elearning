...
<section id="navigation">
  <div id="mySidenav" class="sidenav">
    ...
    <a href="<?php echo web_root; ?>menu.php?q=about" id="about">About Us <i class="fa fa-info-circle pull-right"></i></a>  -->
     <a href="admin_menu.php" id="lesson">Home <i class="fa fa-home pull-right"></i></a> 
	 <a href="course_ad.html" id="exercise">Lesson <i class="fa fa-pencil pull-right"></i></a> 
	 <a href="Download.php" id="download">User Info <i class="fa fa-download pull-right"></i></a> 
	 <a href="About_us.html" id="about">About Us <i class="fa fa-info-circle pull-right"></i></a> 
	 <a href="admin_login.html" id="login">Logout <i class="fa fa-sign-out pull-right"></i></a> 
  </div>
</section>  
